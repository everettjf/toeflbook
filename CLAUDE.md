# Project: TOEFL iBT 2026 116-Day Sprint Plan

## Repo structure

- `book/` — the 116-day study plan: `README.md`, `resources.md`, `ch01`–`ch09` chapter files, `build.sh` (pandoc → typst → `toefl-book.pdf`). Run the build from inside `book/` (`cd book && ./build.sh`).
