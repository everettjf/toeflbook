...
## 1 · Why Interview is hard (and why AI helps)

The new TOEFL 2026 Interview task asks 4 questions, each 45 sec, **with no preparation time**. ETS samples cluster into 3 styles:

- **Opinion/preference:** "Do you prefer studying alone or in a group? Why?"
- **Memory/experience:** "Describe a place you visited that surprised you."
- **Lifestyle/routine:** "How do you usually relax after a stressful week?"
...
- **G1 — Interview structure:** Idea / Reason / Tie-in framing visible in ≥ 80% of recordings
- **G2 — Topic breadth:** 4 categories rehearsed — opinion / memory / lifestyle / hypothetical
- **G3 — AI delivery score:** Petra/FluentPrep "Delivery" score trends up across chapter
- **G4 — Time control:** all 4 answers land 40–45 sec (no truncation, no run-over)
- **G5 — L&R doesn't regress:** a weekly 7-item L&R drill stays ≥ 80%
- **G6 — Other skills maintained:** Reading, Listening, Writing rotation intact

---

## 3 · Modified weekly plan (Speaking — Interview emphasis)
...
- **Sunday** · MAIN = **Interview 4-item mock** · SECONDARY = Writing — Email
- **Monday** · MAIN = Reading · SECONDARY = Writing
- **Tuesday** · MAIN = Listening · SECONDARY = **Speaking — Interview deep drill**
- **Wednesday** · MAIN = Writing · SECONDARY = Reading
- **Thursday** · MAIN = **Speaking — Interview + L&R refresh** · SECONDARY = Listening
...
**Baseline log:**
```
Day 1 Interview Baseline
- Q1 (opinion): Delivery __ Language __ Topic __
- Q2 (memory):  Delivery __ Language __ Topic __
- Q3 (lifestyle): ___
- Q4 (hypothetical): ___
- Most common feedback: ______
```
...
- Q3 (lifestyle): ___
- Q4 (hypothetical): ___
- AI Delivery score trend across chapter (Day 1 vs Day 14): __ → __

### L&R preservation check
- Day 14 L&R: __ / 7  (target ≥ 75% to confirm no regression)

### Goals self-check
- [ ] G1 Idea/Reason/Tie-in visible in ≥ 80% recordings
- [ ] G2 4 categories practiced
- [ ] G3 Delivery score trending up
- [ ] G4 All answers 40–45 sec
- [ ] G5 L&R preserved
...
1. **The new test penalizes canned answers.** Don't memorize 50 sample answers. Memorize the **structure** (15-15-15 sec).
2. **AI Petra is not ETS — but the gap doesn't matter.** What you're training is fluency volume. 50 Petra reps > 5 perfect ETS-scored attempts.
3. **Time mis-management is the #1 fail.** Practice with a visible timer. Stop talking the second the 45 sec mark hits — train the reflex.
4. **Hesitations are fine; restarts are not.** "Um, well, I think..." is normal speech. "Wait, let me start over" tanks the score. Practice **committing** to whatever answer falls out of your mouth.
5. **Don't drift back to Independent Speaking templates.** Those are extinct in the new format. The AI scorer flags template-y openings ("In my opinion, the most important factor...").
